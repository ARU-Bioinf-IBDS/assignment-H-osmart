...
* Write functions in [fasta_gc_content.py](
  ../2_fasta_gc_content/fasta_gc_content.py) to pass the unit tests provided.
  ...
  * [test_lines_from_file.py](../2_fasta_gc_content/test_lines_from_file.py)
    ...
    filename.
  * [test_parse_fasta_lines.py](../2_fasta_gc_content/test_parse_fasta_lines.py)
    ...
    the sequences).
  * [test_parse_fasta_file.py](../2_fasta_gc_content/test_parse_fasta_file.py)
  ...
  * [test_highest_gc_in_fasta_file.py](../2_fasta_gc_content/test_highest_gc_in_fasta_file.py)
  ...
  for instance [rosalind_final_test.txt](../2_fasta_gc_content/rosalind_final_test.txt)
